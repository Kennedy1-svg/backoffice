...
// import AddPayment from './AddPayments.vue'
...
const closeModal:any = () => {
  ...
  let doc:any = document.getElementById('addpayment')
  doc.close()
}
...
const filter:any = async () => {
    ...
    const request:any = `${api_url}api/payment/filter/{pageSize}/{pageNumber}?keyword=${search}`;
...
onMounted(() => {
    // store.commit('setPageTitle', 'Payment List');
    console.log('PaymentHeader mounted');
});
